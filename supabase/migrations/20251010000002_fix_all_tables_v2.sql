...
-- VERSÃO 2: Com verificação de políticas existentes
-- =============================================

-- 1. Criar tabela subscriptions (se não existir)
...
-- Políticas para subscriptions (com verificação)
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- 2. Verificar se profiles existe
