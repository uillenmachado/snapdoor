-- =====================================================
-- SCRIPT SIMPLIFICADO - APENAS LEADS, PIPELINE E DEALS
-- Empresas JÁ EXISTEM - executar apenas estes blocos
-- =====================================================

-- =====================================================
-- 1. LEADS (10 leads profissionais vinculados às empresas)
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE '✅ 10 Leads inseridos com sucesso!';
...
BEGIN
  ...
  RAISE NOTICE '✅ Pipeline + 4 Stages criados!';
...
BEGIN
  ...
  IF v_pipeline_id IS NULL THEN
    RAISE NOTICE '⚠️ Nenhum pipeline encontrado!';
    RETURN;
  END IF;
  ...
  VALUES
    (v_user_id, v_pipeline_id, v_stage_fechamento_id, v_nubank_id, v_lead_cristina, 
     ...
     'Projeto de integração de APIs do SnapDoor CRM com sistemas bancários do Nubank.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_negociacao_id, v_mercadolivre_id, v_lead_fernando, 
     ...
     'Implantação de CRM para equipe de vendas B2B com 50 usuários.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_proposta_id, v_stone_id, v_lead_mariana, 
     ...
     'Solução customizada de CRM integrada com Stone Checkout.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_qualificado_id, v_ifood_id, v_lead_roberto, 
     ...
     'Plataforma CRM para gestão de relacionamento com 50.000+ restaurantes.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_qualificado_id, v_contaazul_id, v_lead_paula, 
     ...
     'Plano Starter para equipe de vendas interna.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_negociacao_id, v_rd_id, v_lead_carlos, 
     ...
     'Migração completa de CRM atual (Salesforce) para SnapDoor.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_proposta_id, v_totvs_id, v_lead_juliana, 
     ...
     'Projeto de integrações bi-direcionais entre SnapDoor CRM e ERPs TOTVS.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_qualificado_id, v_movile_id, v_lead_andre, 
     ...
     'Demo agendada para próxima terça-feira (15/10) às 14h.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_fechamento_id, v_wellhub_id, v_lead_beatriz, 
     ...
     'Projeto de CRM global para expansão em 12 países da LATAM.', 
    ...
    (v_user_id, v_pipeline_id, v_stage_qualificado_id, v_quintoandar_id, v_lead_rafael, 
     ...
     'Trial gratuito de 14 dias solicitado.', 
     NOW() - INTERVAL '8 days', NOW());
  
  RAISE NOTICE '✅ 10 Deals inseridos com sucesso!';
